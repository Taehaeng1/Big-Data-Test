...
bar_width = 0.6  # 작은 값으로 설정하여 막대 간의 간격을 조정
...
ax.set_ylim([0, 1])  # 출산율은 0에서 1 사이의 값이므로 y축 범위를 설정해줍니다.
...
birth_rates_by_age = np.array([
    [0.1, 0.2, 1.3, 5.4, 3.5, 0.9, 0.1],
    [0.1, 0.4, 1.5, 6.2, 4.5, 1.2, 0.2],
    [0.2, 0.5, 1.8, 7.5, 5.1, 1.5, 0.3],
    [0.1, 0.3, 1.6, 6.8, 4.3, 1.0, 0.2],
    [0.2, 0.6, 2.0, 8.1, 6.2, 1.8, 0.4],
    [0.3, 0.7, 2.3, 8.9, 7.0, 2.0, 0.5],
    [0.1, 0.2, 1.2, 5.1, 3.3, 0.8, 0.2],
    [0.3, 0.8, 2.5, 9.3, 7.8, 2.2, 0.6],
    [0.2, 0.5, 2.0, 7.8, 6.1, 1.5, 0.3],
    [0.1, 0.3, 1.5, 6.5, 4.7, 1.0, 0.2],
    [0.2, 0.6, 2.2, 8.5, 7.2, 1.8, 0.4],
    [0.3, 0.8, 2.7, 9.8, 8.5, 2.4, 0.5],
    [0.2, 0.5, 2.1, 7.7, 6.3, 1.6, 0.3],
    [0.1, 0.4, 1.8, 6.1, 4.8, 1.2, 0.2],
    [0.2, 0.6, 2.3, 8.9, 7.4, 2.0, 0.4],
    [0.1, 0.3, 1.4, 6.2, 4.5, 1.1, 0.2],
    [0.2, 0.7, 2.2, 8.8, 7.0, 2.0, 0.5],
    [0.3, 0.8, 2.5, 9.5, 7.8, 2.2, 0.6],
    [0.2, 0.5, 2.0, 7.6, 6.2, 1.5, 0.3],
    [0.1, 0.4, 1.8, 6.2, 4.8, 1.2, 0.2],
    [0.2, 0.6, 2.3, 8.9, 7.4, 2.0, 0.4],
    [0.3, 0.8, 2.7, 9.8, 8.5, 2.4, 0.5],
    [0.2, 0.5, 2.1, 7.7, 6.3, 1.6, 0.3],
    [0.1, 0.4, 1.8, 6.1, 4.8, 1.2, 0.2],
